...
int main(int argc, char** argv)
{
   ...
   for(int index = 2;index<argc;index++)
   {
     ...
     //if(index == 1)
     {
       lwe = new img::LinearWaveEstimate(input_image, alpha);
     }
   ...
   //std::cout<<"successfully get here"<<std::endl;
   //string imagename = clf.find("-image", "", "Image to drive color");
